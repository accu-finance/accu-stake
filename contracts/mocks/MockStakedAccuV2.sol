 ...
 **/
contract MockStakedAccuV2 is IStakedToken, GovernancePowerWithSnapshot, VersionedInitializable, AaveDistributionManager {
  using SafeMath for uint256;
  using SafeERC20 for IERC20;

  string internal constant NAME = 'Staked Accu';
  string internal constant SYMBOL = 'stkACCU';
